...
const AdminActivityFields: React.FC<Props> = ({
  activity,
  onUpdateActivity,
  hapticLight
}) => {
  return (
    <>
      <View className="mb-6">
        <Text className="text-sm font-semibold mb-2 text-gray-700">Title</Text>
        <TextInput
      ...
      <View className="mb-6">
        <Text className="text-sm font-semibold mb-2 text-gray-700">Image URL</Text>
        <TextInput
      ...
      <View className="mb-6">
        <Text className="text-sm font-semibold mb-2 text-gray-700">Category</Text>
        <TextInput
      ...
      <View className="flex-row gap-4 mb-6">
        <View className="flex-1">
          <Text className="text-sm font-semibold mb-2 text-gray-700">Duration (min)</Text>
          <TextInput
            value={activity.duration ? String(activity.duration) : ''}
            onChangeText={(text) => onUpdateActivity({ ...activity, duration: parseInt(text) || undefined })}
            onFocus={hapticLight}
            className="border border-gray-300 rounded px-3 py-2"
            placeholder="30"
        ...
        <View className="flex-1">
          <Text className="text-sm font-semibold mb-2 text-gray-700">Level</Text>
          <TextInput
